...
request.get("https://xat.com/embed/chat.php#id=5&xc=3360&cn=793705656&gb=7tG4d&gn=xat_test").then(function(box) {
	...
	var files = [
		"activity.js",
		"embed.html",
		"www/createjs-2015.11.26.min.js",
		"www/actions.html",
		"www/actions.js",
		"www/chats.html",
		"www/chats.js",
		...
		"www/visitors.js",
		"www/xat2.js",
		"www/XatBackground.jpg",
		"www/xat.css",
		"www/xat.js",
		"www/svg/8ball.svg",
		"www/svg/abchats.svg",
		"www/svg/abfriends.svg",
		"www/svg/abgroups.svg",
		"www/svg/ablogo.svg",
		"www/svg/abme.svg",
		"www/svg/abmore.svg",
		"www/svg/app.svg",
		"www/svg/biggrin.svg",
		"www/svg/bubble2.svg",
		"www/svg/confused.svg",
		"www/svg/cool.svg",
		"www/svg/crying.svg",
		"www/svg/deleteicon.svg",
		"www/svg/eek.svg",
		"www/svg/favorite.svg",
		"www/svg/frown.svg",
		"www/svg/getx.svg",
		"www/svg/groups.svg",
		"www/svg/helpicon.svg",
		"www/svg/mad.svg",
		"www/svg/more.svg",
		"www/svg/notfavorite.svg",
		"www/svg/off.svg",
		"www/svg/on.svg",
		"www/svg/redface.svg",
		"www/svg/selActions.svg",
		"www/svg/selFriends.svg",
		"www/svg/selGroups.svg",
		"www/svg/selPowers.svg",
		"www/svg/sleepy.svg",
		"www/svg/smile.svg",
		"www/svg/spkoff.svg",
		"www/svg/spk.svg",
		...
		"www/svg/x.svg",
		"www/svg/actEdit.svg",
		"www/svg/actPowers.svg",
		"www/svg/actStore.svg",
		"www/svg/actOK.svg",
		"www/svg/actBuyXats.svg",
		"www/svg/actLogin.svg",
		"www/svg/actSettings.svg",
		"www/svg/actDivorce.svg",
		"www/svg/actPrivateChat.svg",
		"www/svg/actPrivateMessage.svg",
		"www/svg/actIgnore.svg",
		"www/svg/actPowers.svg",
		"www/svg/actDivorce.svg",
		"www/svg/actAddAsFriend.svg",
		"www/svg/actTransfer.svg",
		"www/svg/actMakeMember.svg",
		"www/svg/actMakeGuest.svg",
		"www/svg/actKick.svg",
		"www/svg/actMakeOwner.svg",
		"www/svg/actBan.svg",
		"www/svg/actMakeModerator.svg",
		"www/svg/actBan.svg",
		"www/svg/actCancel.svg"
	];
